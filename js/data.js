...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    excerpt: "I used to treat lingerie shopping like a chore — grab something neutral, check out, done. Then I actually explored what Victoria's Secret is doing this season.",
  ...
  },
  {
    ...
    excerpt: "The Angel era meant something different to everyone. For me it was less about runway fantasy and more about finding confidence in everyday pieces.",
  ...
  },
  {
    ...
    excerpt: "I needed outfits that worked for client lunches and Friday drinks without a wardrobe change. Murci turned out to be the label I kept coming back to.",
  ...
  },
  {
    ...
    excerpt: "Summer wardrobe panic hit in late June — nothing felt fresh. Browsing the new Murci drop fixed that faster than a shopping mall ever could.",
  ...
  },
  {
    ...
    excerpt: "A friend from Charleston sent me a dress from The Mint Julep Boutique for a garden wedding. I didn't expect to become a repeat customer.",
  ...
  },
  {
    ...
    excerpt: "When a colleague in Minsk mentioned ordering everything from appliances to skincare through one site, I had to understand why 21vek BY keeps winning.",
  ...
  },
  {
    ...
    excerpt: "From a new blender to birthday perfume — I mapped how one 21vek BY cart replaced four separate errands. Here's what surprised me most.",
  ...
  },
  {
    ...
    excerpt: "Our cheap dishwasher died mid-dinner party. The repair guy said what I already knew: buy once, cry once. That conversation sent me down the Miele rabbit hole.",
  ...
  },
  {
    ...
    excerpt: "Renovating a kitchen is mostly spreadsheets and stress. Choosing Miele appliances was the one decision that still feels good six months after move-in.",
  ...
  },
  {
    ...
    excerpt: "My mum refuses fast fashion and still wants to look current. Bonmarche UK turned out to be her sweet spot — and honestly, mine for work staples too.",
